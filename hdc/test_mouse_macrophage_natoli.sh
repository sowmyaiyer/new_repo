	...
	r1_lines=\`zcat /farline/umw_garberlab/mouse/DC/natoli_ChIP_macrophages/${sample}_1.fastq.gz | wc -l\`
	bwa aln -t 8 /share/data/umw_biocore/Genomes/mm/Mus_musculus/UCSC/mm9/Sequence/BWAIndex/genome.fa  /farline/umw_garberlab/mouse/DC/natoli_ChIP_macrophages/${sample}_1.fastq.gz > ../bwa_out/${sample}.se.sai
	bwa samse /share/data/umw_biocore/Genomes/mm/Mus_musculus/UCSC/mm9/Sequence/BWAIndex/genome.fa  ../bwa_out/${sample}.se.sai  /farline/umw_garberlab/mouse/DC/natoli_ChIP_macrophages/${sample}_1.fastq.gz > ../bwa_out/${sample}.se.sam
...
#        # begin QC
	...
	""" > ../bsubFiles/mouse_macrophage_natoli_${sample}.bsub
