require("ggplot2")
fpkm_enhancers_closest_gene <- as.data.frame(read.table("../txt/fpkm_genes_closest_to_atac_enhancers_noCTCF.txt"))
fpkm_nonenhancers_closest_gene <- as.data.frame(read.table("../txt/fpkm_genes_closest_to_atac_nonenhancers_noCTCF.txt"))
fpkm_random_closest_gene <- as.data.frame(read.table("../txt/fpkm_genes_closest_to_random_distal_regions_noCTCF.txt"))
...
#fpkm_enhancers_all_genes_within5k <- as.data.frame(read.table("../txt/enhancer_fpkm_all_genes_within_5000.txt"))
#fpkm_nonenhancers_all_genes_within5k <- as.data.frame(read.table("../txt/nonenhancer_fpkm_all_genes_within_5000.txt"))

#fpkm_all_5k <- rbind(fpkm_enhancers_all_genes_within5k,fpkm_nonenhancers_all_genes_within5k)
#colnames(fpkm_all_5k) <- c("type","fpkm")

fpkm_enhancers_closest_gene_within5k <- as.data.frame(read.table("../txt/fpkm_genes_closest_to_atac_enhancers_within5k_noCTCF.txt"))
fpkm_nonenhancers_closest_gene_within5k <- as.data.frame(read.table("../txt/fpkm_genes_closest_to_atac_nonenhancers_within5k_noCTCF.txt"))
fpkm_random_closest_gene_within5k <- as.data.frame(read.table("../txt/fpkm_genes_closest_to_random_distal_regions_within5k_noCTCF.txt"))
...
fpkm_enhancers_closest_gene_within10k <- as.data.frame(read.table("../txt/fpkm_genes_closest_to_atac_enhancers_within10k_noCTCF.txt"))
fpkm_nonenhancers_closest_gene_within10k <- as.data.frame(read.table("../txt/fpkm_genes_closest_to_atac_nonenhancers_within10k_noCTCF.txt"))
fpkm_random_closest_gene_within10k <- as.data.frame(read.table("../txt/fpkm_genes_closest_to_random_distal_regions_within10k_noCTCF.txt"))
...
pdf("../results/expression_closest_genes_noCTCF.pdf", onefile=TRUE)
